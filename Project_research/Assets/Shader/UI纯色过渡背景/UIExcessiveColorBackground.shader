...
Shader "Babybus/UI/UIExcessiveColorBackground"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        CGPROGRAM
            ...
            v2f vert(appdata_t v)
            {
				...
				OUT.texcoord = TransfromUV(v.texcoord, _MainTex_ST ,_Angle);
            ...
            {
				float lerpcolor = saturate(1- (IN.texcoord.y + _length ) /_BlendRange);
				
                half4 color = lerp(IN.color,_Color2,lerpcolor);
