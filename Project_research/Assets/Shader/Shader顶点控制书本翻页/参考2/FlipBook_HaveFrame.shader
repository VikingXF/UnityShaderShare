Shader "Babybus/Special/FlipBook_HaveFrame"
{
	Properties
	{
		_FramePage ("Frame Page", 2D) = "white" {}
		_MainPage1 ("Page1", 2D) = "white" {}
		_MainPage2 ("Page2", 2D) = "white" {}
		_PageAngle ("CurPageAngle", Range(0,1)) = 0
		//_PageAlpha ("Page Alpha", Range(0,1)) = 0 		
	...
	SubShader
	{
		...
		fixed4 frag_flip (v2f i) : SV_Target
		{
			...
			fixed4 Framecol = tex2D(_FramePage, i.uv);
			col.rgb = lerp(col.rgb,Framecol.rgb,Framecol.a);
