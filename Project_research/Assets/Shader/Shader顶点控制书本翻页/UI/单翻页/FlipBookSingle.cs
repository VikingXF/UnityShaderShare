...
public class FlipBookSingle : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        bookmaterial.SetTexture("_MainPage2", bookTex2[page]);
        bookmaterial.SetTexture("_MainPage3", bookTex[page]);
        bookmaterial.SetTexture("_MainPage4", bookTex2[page]);
    ...
    public void Leftflip()
    {
        ...
        bookmaterial.SetTexture("_MainPage2", bookTex2[page - 1]);
        bookmaterial.SetTexture("_MainPage3", bookTex[page]);
        bookmaterial.SetTexture("_MainPage4", bookTex2[page]);
    ...
    public void Rightflip()
    {
        ...
        bookmaterial.SetTexture("_MainPage1", bookTex[page]);
        bookmaterial.SetTexture("_MainPage2", bookTex2[page]);
        bookmaterial.SetTexture("_MainPage3", bookTex[page+1]);
        bookmaterial.SetTexture("_MainPage4", bookTex2[page + 1]);
