Shader "Babybus/Water/WatersurVert"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            v2f vert (appdata v)
            {
				...
				fixed offset1 = _amplitude1 * cos((v.uv.x)*_remap1 + _Time.y*_TimeScale1);
				
				fixed offset2 = _amplitude2 * sin((v.uv.x)*_remap2 + _Time.y*_TimeScale2);
				
				v.vertex.y +=offset1+offset2;
