...
*/
Shader "Babybus/Water/transparence water(2Tex)"
{
	Properties
	{		
	...
	SubShader
	{
		...
		Pass
		{
			...
			{
				v2f o;
				o.uv0.xy = TRANSFORM_TEX(v.texcoord0, _Tex1);
				o.uv0.zw = TRANSFORM_TEX(v.texcoord1, _MaskTex);
			...
			fixed4 frag (v2f i) : SV_Target
			{
				...
				fixed4 Texcol1 = tex2D(_Tex1, i.uv0.xy);
				fixed4 Texcol2 = tex2D(_Tex2, i.uv0.xy);

				float4 Color = lerp(Texcol1,Texcol2,Maskcol.r);
