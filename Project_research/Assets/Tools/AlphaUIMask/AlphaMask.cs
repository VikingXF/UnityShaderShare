...
namespace AlphaMask
{
    ...
    public class AlphaMask : MonoBehaviour
    {
        ...
        void Start()
        {
            _maskedSpriteWorldCoordsShader = Shader.Find("Babybus/UI/Sprites Alpha Mask");
            _maskedUnlitWorldCoordsShader = Shader.Find("Babybus/UI/Unlit Alpha Mask");
