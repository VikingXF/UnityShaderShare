...
public class RapidBlurEffect : MonoBehaviour
{
    ...
    void OnRenderImage(RenderTexture sourceTexture, RenderTexture destTexture)
    {
        ...
        if (CurShader != null)
        {
            ...
            //将原始纹理跟renderBuffer根据中心距离进行区域模糊
            
                CurMaterial.SetTexture("_MaskTex", MaskTex);
            CurMaterial.SetTexture("_BlurTex", renderBuffer);
            Graphics.Blit(sourceTexture, destTexture, CurMaterial,3);
