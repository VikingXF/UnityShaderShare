...
[ExecuteInEditMode]
[AddComponentMenu("Screen Effects/MaskBlurEffect")]
public class MaskBlurEffect : MonoBehaviour
{
    #region Variables
    private string ShaderName = "Babybus/Screen Effects/MaskBlurEffect";
