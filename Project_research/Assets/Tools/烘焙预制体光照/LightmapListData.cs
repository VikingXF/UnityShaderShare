...
[ExecuteInEditMode]
public class LightmapListData : MonoBehaviour
{
    [System.Serializable]
    struct RendererInfo
    {
...
#if UNITY_EDITOR
    [UnityEditor.MenuItem("Tools/烘培预制体光照/SaveLightMapList(场景已烘焙)")]
    static void GenerateLightmapInfo()
    {
        ...
        LightmapListData[] prefabs = FindObjectsOfType<LightmapListData>();
